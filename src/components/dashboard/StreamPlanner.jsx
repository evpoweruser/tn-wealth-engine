...
/**
 * StreamPlanner — college stream cost planner (extracted from GoalOptimizerPanel).
 * Pick a child + stream → projected entry cost, required SIP, live plan impact,
 * one-click Apply. Reverse Solver stays in the Stress Lab.
 */
export const StreamPlanner = () => {
    ...
    <div className={styles.panelContainer}>
      <div className={styles.header}>
        <div className={styles.titleGroup}>
          ...
          <div>
            <div className={styles.title}>College Stream Planner <InfoButton id="stream-planner" /></div>
            <div className={styles.subTitle}>
              What will each stream cost at entry — and can the plan afford it?
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={styles.tradeoffContainer}>
        {!activeChild ? (
          <div className={styles.noChildrenNotice}>
            No child education goals added yet. Add a child card above to plan college streams.
          </div>
        ) : (
          <>
